...
?? PROTOCOLO DE IM�GENES (ESTRATEGIA VISUAL UNIFICADA)
Fecha de Aprobaci�n: 24-Nov-2025 Objetivo: Garantizar coherencia visual y proteger al usuario ("Pepe") de errores al subir im�genes de diferentes formatos.

1. LA LEY GLOBAL: "Curva de 16px"
Todas las im�genes, contenedores destacados y tarjetas del sitio deben respetar el radio de borde unificado. Se acabaron los bordes rectos.
...
Im�genes Hero (.post-hero-image)

2. ESTRATEGIA A: "ESCAPARATE" (Listados y Productos)
Uso: Tarjetas del Cat�logo y Destacados de la Home. Objetivo: Mostrar el objeto entero (Libro, Icono, Foto) sin recortar nada. Efecto "Producto en estanter�a".

Comportamiento:

Ajuste: object-fit: contain (La imagen se encoge hasta caber entera).

Fondo: var(--color-bg-neutral) (Gris suave que act�a como "mesa" o paspart�).

Efecto: Levitaci�n (drop-shadow). La imagen proyecta sombra sobre el fondo, no el contenedor.

Raz�n: Si Pepe sube un Ebook vertical o un logo cuadrado, NUNCA se cortar�. Se ver� flotando elegantemente en el centro.

Clases CSS: .card-image-resource.

3. ESTRATEGIA B: "INMERSIVA" (Ambientaci�n)
Uso: Cabeceras Hero, Foto de Perfil ("Sobre M�"), Cabecera de Art�culo Individual (publicacion.html), Listado del Blog (Zig-Zag). Objetivo: Impacto emocional y llenado de espacio.
...
Raz�n: Aqu� buscamos atm�sfera. Un borde gris alrededor de una foto de paisaje o de una cara queda "pobre". Queremos inmersi�n total.

Clases CSS: .hero-image, .about-image, .post-hero-image, .blog-entry-image.

RESUMEN R�PIDO PARA DESARROLLO

Ubicaci�n,Tipo de Imagen,Ajuste (object-fit),Fondo,Efecto
Home (Grid),Producto/Post,contain,Gris Neutro,Levitaci�n
Cat�logo,Producto,contain,Gris Neutro,Levitaci�n
